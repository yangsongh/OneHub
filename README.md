...
**OneHub** 是一个轻量级、功能丰富的网络服务聚合服务器，专为局域网环境打造。它集成了文件浏览器、HTTP/SOCKS5代理、WebSocket实时控制台、定时新闻下载器、FTP服务器和LocalProxy配套服务端等多种功能，能够在一台设备上快速搭建完整的网络服务中枢。
...
```jsonc
{
  ...
  "domain_whitelist": ["*.example.com", "music.163.com", "*.bilibili.com"],
}
```
